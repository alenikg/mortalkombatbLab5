...
public class JFrames extends javax.swing.JFrame {
    ...
    private void showNewLocationMessage(Component parentComponent) {
        JOptionPane.showMessageDialog(
                parentComponent,
                "Новая локация: " + game.currLocationIndex,
                "!",
                JOptionPane.INFORMATION_MESSAGE
        );
    }
    ...
    private void initComponents() {
        ...
        jButton13.setText("Ослабить противника");
        ...
        jLabel34.setFont(new java.awt.Font("Comic Sans MS", 1, 42)); // NOI18N
        jLabel34.setForeground(new java.awt.Color(0, 51, 255));
        jLabel34.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel34.setText("Локация пройдена");
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGap(90, 90, 90)
                        .addComponent(jLabel33, javax.swing.GroupLayout.PREFERRED_SIZE, 467, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGap(90, 90, 90)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String rawValue = JOptionPane.showInputDialog(this,"Сколько локаций пройти?");
        if (rawValue == null) {
            return;
        }
        try {
            game.setLocationCount(Integer.parseInt(rawValue.trim()));
        } catch (Exception e) {
            this.showErrorMessage(this, "Введите количество локаций цифрами");
...
//        jDialog7.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
//        jDialog7.setBounds(300, 200, 430, 350);
//        jDialog7.setLocationRelativeTo(jFrame1);
...
//        jDialog7.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        enemy=game.fight.NewRound(human, jLabel4, jProgressBar1, jProgressBar2,
                jLabel5, jLabel10, jLabel13, game);
        game.change.NewRoundTexts(human, enemy, jProgressBar1, jProgressBar2, 
                jLabel17, jLabel16, jLabel6, jLabel19, jLabel12, jLabel13, jLabel9,
                jLabel26, jLabel27, game.fight.i, items, jRadioButton1, jRadioButton2, jRadioButton3);
        jDialog1.dispose();
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        jLabel35.setText("");
        jLabel36.setText("");
        game.incrementCurrLocation();
        enemy=game.fight.NewRound(human, jLabel4, jProgressBar1, jProgressBar2,
                jLabel5, jLabel10, jLabel13, game);
        if (game.hasNotLocation()) {
            jDialog7.dispose();
